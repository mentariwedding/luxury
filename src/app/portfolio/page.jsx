...
const DEFAULTS = [
  {
    id: 1,
    title: "Pesta Penuh Tawa",
    category: "Romantic",
    image_url: "/images/tawalepas.JPG",
  },
  {
    id: 2,
    title: "Detail Penuh Makna",
    category: "Elegant",
    image_url: "/images/hangat.JPG",
  },
  {
    id: 3,
    title: "Momen Tak Terlupakan",
    category: "Natural",
    image_url: "/images/estetik.JPG",
  },
  {
    id: 4,
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Karya <span className="italic gold-gradient-text">Pilihan</span>
          </h1>
          ...
          <p className="font-serif italic text-[#A3A3A3] text-base md:text-lg leading-relaxed max-w-xl">
            Tidak ada dua perayaan yang sama. Setiap fragmen di bawah adalah
            sepenggal cerita yang kami rancang dengan penuh ketulusan.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.span
            ...
            className="ml-auto self-center text-[9px] uppercase tracking-[0.4em] text-white/20 font-light"
          >
        ...
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="aspect-[4/5] bg-white/[0.02] animate-pulse"
              />
            ))}
          </div>
        ) : (
        ...
        {filtered.length === 0 && !loading && (
          <div className="text-center py-24">
            <p className="font-serif italic text-white/30 text-2xl mb-2">
