...
const DEFAULTS = [
  {
    id: 1,
    slug: "sabtu-di-lereng-gunung",
    title: "Sebuah Sabtu di Lereng Gunung",
    tagline:
      "Ketika kabut turun tepat saat ijab kabul, kami tahu alam pun ikut menjadi saksi.",
    aesthetic_tag: "Natural",
    venue_hint: "Lereng Gunung, Sukabumi Selatan",
    season: "Musim Hujan 2024",
    cover_image: "/images/tawalepas.JPG",
  },
  {
    id: 2,
    slug: "ketika-hujan-menjadi-rencana",
    title: "Ketika Hujan Menjadi Bagian dari Rencananya",
    tagline:
      "Tidak ada yang bisa mengontrol cuaca. Tapi ada yang bisa memilih cara merayakannya.",
    aesthetic_tag: "Elegant",
    venue_hint: "Kediaman Keluarga, Bogor",
    season: "Musim Hujan 2023",
    cover_image: "/images/hangat.JPG",
  },
  {
    id: 3,
    slug: "taman-yang-menunggu",
    title: "Taman yang Sudah Menunggu Dua Tahun",
    tagline:
      "Mereka menunda pernikahannya dua kali. Ketika akhirnya tiba, semuanya terasa sempurna.",
    aesthetic_tag: "Romantic",
    venue_hint: "Taman Keluarga, Sukabumi Utara",
    season: "Musim Kemarau 2024",
    cover_image: "/images/estetik.JPG",
  },
];
  ...
  useEffect(() => {
    (async () => {
      const { data } = await supabase
        ...
        .select(
          "id, slug, title, tagline, aesthetic_tag, venue_hint, season, cover_image",
        )
      ...
      >
        ...
        >
          ...
          <p className="font-serif italic text-[#A3A3A3] text-base md:text-lg leading-relaxed max-w-xl">
            Tidak ada nama. Tidak ada detail yang mengidentifikasi. Hanya cerita
            — karena setiap momen terbaik layak untuk diceritakan, bukan
            diekspos.
          </p>
        </motion.div>
              ...
              <Reveal key={entry.id || i} delay={i * 120}>
                <Link href={`/kisah/${entry.slug}`} className="group block">
                  ...
                  >
                    {/* Cover image */}
                    <div
                      className="overflow-hidden border border-[#CEB175]/8 bg-[#0A0A0A] aspect-[16/10] relative"
                      style={{ direction: "ltr" }}
                    >
                      {entry.cover_image ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <span className="font-serif italic text-white/10 text-4xl">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[8px] uppercase tracking-[0.5em] text-[#CEB175]/70 font-light">
                          {entry.aesthetic_tag}
                        </span>
                      </div>
                      <h2
                        className="font-serif font-light text-white group-hover:text-[#CEB175] transition-colors duration-500 leading-tight"
        ...
        <motion.div
          ...
          className="mt-24 text-center border-t border-[#CEB175]/10 pt-16"
        >
          <p className="text-[9px] uppercase tracking-[0.6em] text-white/15 mb-8">
            Setiap cerita dimulai dari percakapan
          </p>
          <a
            href="/#manifesto"
