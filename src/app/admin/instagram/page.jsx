                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-b border-white/[0.08] px-0 py-2.5 text-sm text-white placeholder:text-white/10 focus:outline-none focus:border-b-[#CEB175]/40 transition-colors"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-b border-white/[0.08] px-0 py-2.5 text-sm text-white placeholder:text-white/10 focus:outline-none transition-colors"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                />
                                <div className="border-2 border-dashed border-white/[0.07] p-6 text-center hover:border-[#CEB175]/25 transition-colors duration-300">
                                    {file ? (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-transparent border-b border-white/[0.08] px-0 py-2.5 text-sm text-white focus:outline-none transition-colors"
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-center gap-2 border py-3 text-sm transition-all duration-300 ${
                                        form.is_active
    ...
    return (
        <div className="luxury-section">
            ...
            <motion.div custom={1} variants={fadeUp} initial="hidden" animate="visible"
                className="mb-10 p-5 border border-[#CEB175]/10 bg-[#CEB175]/[0.02]">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {posts.map((post, i) => (
                            <motion.div
                                ...
                                className={`group relative bg-white/[0.02] border overflow-hidden transition-colors duration-500 ${
                            ...
                            >
                                ...
                                <div className="absolute top-2 right-2 flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    ...
                                    <MinimalistTooltip text="Hapus">
                                        <button
                                            ...
                                            className="w-8 h-8 bg-red-500/10 text-red-400 flex items-center justify-center hover:bg-red-500 hover:text-white transition-all duration-300"
                                        >
                                ...
                                <div className="absolute top-2 left-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <span className="text-[8px] bg-black/60 backdrop-blur-sm text-white/50 px-2 py-1">
                                        #{post.display_order}
                                    </span>
                                </div>
                            </motion.div>
