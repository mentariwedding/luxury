...
const NAV_GROUPS = [
    {
        label: null,
        items: [{ label: 'Dashboard', href: '/admin', exact: true, icon: LayoutDashboard }],
    },
    {
        label: 'Konten',
        items: [
...
export default function AdminLayout({ children }) {
    ...
    return (
        <ToastProvider>
        <ConfirmProvider>
        <div className="min-h-screen bg-[#040404] text-white flex"
            ...
            <aside className="hidden md:flex flex-col fixed left-0 top-0 bottom-0 w-[220px] bg-[#040404] border-r border-white/[0.04] z-50">
                ...
                <Link href="/admin"
                    ...
                    <div className="flex flex-col min-w-0">
                        <span className="font-serif text-[15px] tracking-[0.15em] text-white leading-none">Mentari</span>
                        <span className="text-[7px] uppercase tracking-[0.5em] text-[#CEB175]/40 mt-1">Admin Suite</span>
                    </div>
                </Link>
            ...
            <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-[#040404]/95 backdrop-blur-xl border-b border-white/[0.04]">
                ...
                <div className="flex items-center justify-between px-5 h-[56px]">
                    <Link href="/admin" className="flex items-center gap-2.5">
                        ...
                        <span className="font-serif text-[15px] tracking-[0.15em]">Mentari</span>
                    </Link>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-6 h-[56px] border-b border-white/[0.04]">
                            <div className="flex items-center gap-2.5">
                                <SunMedium className="w-4 h-4 text-[#CEB175]" />
                                <span className="font-serif text-[15px] tracking-[0.15em]">Mentari</span>
                                <span className="text-[7px] uppercase tracking-[0.4em] text-[#CEB175]/30 mt-0.5">Admin Suite</span>
                            </div>
