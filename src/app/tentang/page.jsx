...
const MILESTONES = [
  {
    year: "2019",
    title: "Awal Mula",
    desc: "Mentari lahir dari sebuah keyakinan sederhana — bahwa setiap pernikahan adalah karya seni yang layak dirawat dengan sepenuh hati.",
  },
  {
    year: "2020",
    title: "Menemukan Suara",
    desc: "Di tengah keheningan yang tak terduga, kami menemukan cara baru untuk merangkai cerita — lebih intim, lebih personal, lebih bermakna.",
  },
  {
    year: "2022",
    title: "Filosofi Terbentuk",
    desc: "Kami memilih untuk menolak volume. Setiap tahun, hanya sejumlah kecil perayaan yang kami terima — agar setiap detail mendapat perhatian penuh.",
  },
  {
    year: "2024",
    title: "Lebih dari 60 Cerita",
    desc: "Enam puluh lebih pasangan telah mempercayakan hari paling istimewa mereka kepada kami. Setiap satu adalah kehormatan yang tidak kami anggap ringan.",
  },
  {
    year: "Kini",
    title: "By Inquiry Only",
    desc: "Mentari bukan untuk semua orang — dan itu bukan kesombongan. Itu adalah komitmen kami bahwa Anda mendapatkan yang terbaik dari kami.",
  },
];
  ...
  return (
    ...
    >
      <main>
          ...
          <div className="container mx-auto px-6 md:px-12 max-w-[1200px] relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-end">
              <div>
                ...
                >
                  Mentari Wedding adalah studio pernikahan eksklusif di Sukabumi
                  — didirikan atas keyakinan bahwa setiap pernikahan berhak atas
                  perhatian yang utuh, bukan sekadar eksekusi daftar tugas.
                </motion.p>
              </div>
              ...
              >
                {[
                  ...
                  <div
                    key={i}
                    className="py-10 px-6 text-center border-r border-[#CEB175]/10 last:border-0"
                  >
                    <p
                      className="font-serif font-light text-white mb-2 leading-none"
                      style={{ fontSize: "clamp(28px, 4vw, 44px)" }}
                    >
                      <span className="gold-gradient-text italic">{s.num}</span>
                    </p>
                    <p className="text-[8px] uppercase tracking-[0.4em] text-white/30 font-light leading-relaxed whitespace-pre-line">
                      {s.label}
                    </p>
                  </div>
                ))}
        ...
        {/* ── Pull Quote ── */}
        <section
          className="border-y border-[#CEB175]/8 bg-[#080808]"
          style={{
        ...
        >
          <div className="container mx-auto px-6 md:px-12 max-w-4xl text-center">
            <Reveal>
              <p
                className="font-serif font-light text-white leading-[1.2]"
              ...
              >
                ...
                <span className="italic gold-gradient-text">
                  Ada keheningan di balik setiap kemewahan
                </span>{" "}
        ...
        >
          <Reveal>
            <p className="text-[10px] uppercase tracking-[0.5em] text-[#CEB175] mb-4 font-light">
              — Perjalanan Kami —
            </p>
            <h2
              className="font-serif font-light text-white mb-16 md:mb-20"
                ...
                <Reveal key={i} delay={i * 100}>
                  <div className="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-4 md:gap-12 items-start">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-serif italic text-[#CEB175] text-lg md:text-xl">
                        {m.year}
                      </span>
                    </div>
                    <div>
                      <h3 className="font-serif text-white font-light text-xl md:text-2xl mb-3">
                        {m.title}
                      </h3>
                      <p className="text-[#A3A3A3] font-light text-sm md:text-base leading-relaxed">
                        {m.desc}
                      </p>
                    </div>
                  </div>
        ...
        {/* ── Nilai / Values ── */}
        <section
          className="bg-[#070707] border-t border-[#CEB175]/8"
          style={{
            paddingTop: "clamp(80px, 12vh, 140px)",
            paddingBottom: "clamp(80px, 12vh, 140px)",
          }}
        >
          <div className="container mx-auto px-6 md:px-12 max-w-[1200px]">
            <Reveal>
              ...
              >
                Yang Kami Percayai,{" "}
                <span className="italic gold-gradient-text">Setiap Hari</span>
              </h2>
            </Reveal>
              ...
              {VALUES.map((v, i) => (
                <Reveal key={i} delay={i * 150}>
                  <div className="p-8 md:p-10 border-r border-[#CEB175]/8 last:border-0 h-full">
                    <span className="font-serif italic text-[#CEB175]/30 text-4xl block mb-6">
                      {v.num}
                    </span>
                    <h3 className="font-serif font-light text-white text-lg md:text-xl mb-4 leading-snug">
                      {v.title}
                    </h3>
        ...
        >
          <div className="container mx-auto px-6 md:px-12">
            <Reveal>
              <p className="text-[10px] uppercase tracking-[0.6em] text-[#CEB175]/50 mb-6">
                Siap Memulai Percakapan?
              </p>
              <h2
                className="font-serif font-light text-white mb-10 leading-tight"
                style={{ fontSize: "clamp(28px, 4vw, 56px)" }}
              >
                Ceritakan{" "}
                <span className="italic gold-gradient-text">Hari Istimewa</span>{" "}
                Anda.
              </h2>
            </Reveal>
            <Reveal delay={200}>
