...
export default function Marquee() {
  ...
  const skewX = useTransform(skewVelocity, [-800, 0, 800], [8, 0, -8]);

  const separator = (
    <span className="mx-12 md:mx-20 text-[#CEB175]/40 font-serif text-lg select-none">
      ✦
    </span>
  );
  ...
  return (
    <div className="relative overflow-hidden py-10 md:py-14 bg-[#050505] border-y border-[#CEB175]/5 gold-shimmer">
      ...
      <motion.div className="animate-marquee-content" style={{ skewX }}>
