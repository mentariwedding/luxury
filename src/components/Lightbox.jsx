...
export default function Lightbox({
  ...
  const handleTouchEnd = (e) => {
    ...
    if (dx > 0 && hasPrev) onNavigate?.(currentIndex - 1); // swipe right = prev
    if (dx < 0 && hasNext) onNavigate?.(currentIndex + 1); // swipe left = next
  };
      ...
      {isOpen && current && (
        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-[8px] uppercase tracking-[0.4em] text-white/15 font-light md:hidden">
