...
export default function Atelier() {
  ...
  const [pillars, setPillars] = useState([
    {
      ...
      description:
        "Kami memilih material berkualitas—dari kain sutra hingga detail terkecil—untuk memberikan kenyamanan yang elegan.",
    ...
    },
    {
      ...
      description:
        "Setiap elemen ditata dengan rapi agar menciptakan suasana yang indah dan menenangkan mata.",
    ...
    },
    {
      ...
      description:
        "Pencahayaan yang diatur dengan tepat untuk membangun emosi dan kehangatan di setiap sudut acara.",
  ...
  return (
    <>
      <section
        id="atelier"
        className="luxury-section bg-[#050505] section-ambient"
      >
        <div className="container mx-auto px-6 md:px-12">
              ...
              <Reveal key={index} delay={200 + index * 200}>
                <div className="flex flex-col group cursor-pointer">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-[10px] uppercase tracking-[0.3em] text-[#CEB175]">
                      {pillar.tag}
                    </span>
                  </div>
                  <h3 className="font-serif text-2xl text-white mb-4 font-light tracking-[0.05em]">
                    {pillar.title}
                  </h3>
          ...
          <Reveal delay={800}>
            <div className="mt-20 md:mt-28 flex flex-col md:flex-row items-center justify-between gap-8 border-t border-[#CEB175]/10 pt-10">
              <div>
                <p className="text-[9px] uppercase tracking-[0.5em] text-white/25 font-light mb-2">
                  Koleksi Visual
                </p>
