...
export default function Signature() {
  ...
  const [content, setContent] = useState({
    ...
    description:
      "Di Mentari Wedding, kami tidak mengejar tren yang cepat hilang. Kami berfokus pada estetika yang akan tetap terlihat indah puluhan tahun dari sekarang.\n\nSetiap acara yang kami tangani memiliki ciri khas: perpaduan antara kemewahan yang tenang, detail yang rapi, dan suasana yang hangat.",
  ...
  return (
    <section
      id="signature"
      ref={containerRef}
      className="luxury-section bg-[#0A0A0A] relative overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <Reveal delay={200} className="w-full lg:w-1/2 order-2 lg:order-1">
            <div className="relative max-w-md mx-auto lg:mx-0">
              <div
                className="aspect-[3/4] overflow-hidden border border-[#CEB175]/20 relative"
              ...
              <div className="absolute -bottom-8 -right-8 bg-[#050505] px-6 py-5 border border-[#CEB175]/20 hidden md:block z-10 shadow-2xl">
                <p className="font-serif text-[#CEB175] text-xs italic mb-1 tracking-[0.2em]">
                  Est. 2019
                </p>
                <p className="text-white text-[9px] uppercase tracking-[0.45em] font-light">
                  Sukabumi, Jawa Barat
                </p>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <Reveal>
              <p className="gold-gradient-text text-[10px] uppercase tracking-[0.4em] mb-6 font-medium">
                {content.subtitle}
              </p>
            </Reveal>
            <Reveal delay={200}>
            ...
            <Reveal
              delay={400}
              className="space-y-6 text-[#A3A3A3] font-light leading-relaxed max-w-lg text-sm md:text-base"
            >
              {paragraphs.map((p, i) => (
                <p key={i}>{p}</p>
              ))}
