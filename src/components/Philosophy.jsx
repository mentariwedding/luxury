...
export default function Philosophy() {
    ...
    const [features, setFeatures] = useState([
        { title: 'Eksklusif', description: 'Kami hanya melayani sedikit klien untuk memastikan setiap pernikahan mendapatkan perhatian penuh.' },
        { title: 'Personal',  description: 'Setiap dekorasi dan alur acara kami buat khusus sesuai dengan karakter unik Anda.' },
        { title: 'Tenang',    description: 'Kami menjaga semua detail teknis agar Anda bisa menikmati hari bahagia dengan tenang.' },
    ]);
    ...
    return (
        <section id="philosophy" className="luxury-section relative bg-[#0A0A0A] section-ambient">
            {/* Subtle radial glow */}
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10">
                        ...
                        <Reveal key={i} delay={200 + i * 150}>
                            <div className="group grid grid-cols-12 gap-4 md:gap-8 py-10 md:py-14 items-start cursor-default">
                                ...
                                <div className="col-span-2 md:col-span-1">
                                    <span className="font-serif italic text-[#CEB175]/35 group-hover:text-[#CEB175]/70 transition-colors duration-700"
                                ...
                                <div className="col-span-10 md:col-span-4 lg:col-span-3">
                                    <h3 className="font-serif font-light text-white group-hover:text-[#CEB175] transition-colors duration-700 leading-tight"
                ...
                <Reveal delay={600}>
                    <div className="mt-16 md:mt-20 flex flex-col md:flex-row items-start md:items-center gap-6 pt-10 border-t border-[#CEB175]/10">
                        <span className="flex-shrink-0 text-[9px] uppercase tracking-[0.5em] text-[#525252] font-light">Prinsip kami</span>
                        <p className="font-serif italic text-[#CEB175]/60 text-lg md:text-xl font-light">
                            &ldquo;Kemewahan sejati adalah ketika Anda tidak perlu memikirkan apa pun kecuali menikmati momen.&rdquo;
                        </p>
                    </div>
                </Reveal>
            </div>
