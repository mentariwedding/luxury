...
export default function Portfolio() {
  ...
  return (
    <section
      id="portfolio"
      className="luxury-section px-6 md:px-12 max-w-[1500px] mx-auto"
    >
      {/* Magazine masthead */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-8 border-b border-[#CEB175]/10 pb-10">
        <div className="max-w-2xl relative">
          ...
          <Reveal delay={800}>
            <p className="text-[#A3A3A3] font-light tracking-wide leading-relaxed max-w-lg italic font-serif">
              Tidak ada dua perayaan yang sama. Berikut, beberapa fragmen yang
              kami pilih untuk dibagikan.
            </p>
          </Reveal>
        ...
        <Reveal delay={400}>
          <div className="flex flex-col items-end gap-2">
            ...
            <span className="font-serif italic text-lg text-[#CEB175]">
              Mentari Wedding
            </span>
          </div>
        </Reveal>
...
function EditorialCard({
  ...
  return (
    <motion.div
      ...
      style={{
        borderColor: "rgba(206,177,117,0.08)",
        rotateX: springX,
        rotateY: springY,
