...
export default function Whisper() {
  ...
  const [whispers, setWhispers] = useState([
    {
      quote: "Ada momen yang tak bisa direncanakan. Ia datang sendiri.",
      accent_word: "datang",
    },
    {
      quote:
        "Di antara keheningan janji, kami merangkai kenangan yang paling berkesan.",
      accent_word: "keheningan",
    },
    {
      quote: "Kami tidak mengejar tren. Kami mengundang keabadian.",
      accent_word: "keabadian",
    },
  ]);
  ...
  useEffect(() => {
    (async () => {
      ...
      if (s)
        setIntro({
          subtitle: s.subtitle || intro.subtitle,
          description: s.description || intro.description,
        });
    })();
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-6xl relative z-10">
        ...
        <div className="mb-24 md:mb-32 text-center">
          ...
          <motion.p
            ...
            className="font-serif italic text-base md:text-xl text-[#A3A3A3] max-w-2xl mx-auto leading-relaxed font-light"
          >
            {intro.description}
          </motion.p>
        </div>
        ...
        <div className="space-y-16 sm:space-y-24 md:space-y-32">
          {whispers.map((w, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`max-w-3xl px-2 sm:px-0 ${isEven ? "text-left" : "text-right"}`}
                >
                  <span className="block text-[10px] uppercase tracking-[0.5em] text-[#CEB175]/40 mb-6 font-light">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <p className="font-serif text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-light text-white leading-[1.15] tracking-tight text-balance">
