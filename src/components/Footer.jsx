...
export default function Footer() {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      ...
      // Graceful: even if table doesn't exist, show success
      setSubState("success");
      setEmail("");
    }
  };
  ...
  return (
    <footer className="bg-[#050505] text-white pt-20 sm:pt-28 md:pt-40 pb-20 overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col items-center text-center">
            <Reveal>
              <div className="flex items-center gap-4 mb-10 opacity-40">
                ...
                <span className="text-[10px] uppercase tracking-[0.8em] text-[#CEB175]">
            ...
            <div className="relative z-10">
              <Reveal delay={400}>
                <p className="font-serif text-3xl md:text-7xl font-light mb-8 max-w-4xl mx-auto leading-tight px-4">
                  Mari merangkai{" "}
                  <span className="italic text-[#CEB175]">cerita abadi</span>{" "}
                  Anda bersama kami.
                </p>
              </Reveal>
              <Reveal delay={600}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 border-t border-[#CEB175]/10 pt-20">
          ...
          <Reveal className="md:col-span-3" delay={200}>
            <p className="text-[10px] uppercase tracking-[0.4em] text-[#525252] mb-10">
              Koneksi Sosial
            </p>
            <div className="flex flex-col gap-8">
              ...
              <a
                href={`https://www.google.com/maps?q=${settings.map_coordinates}`}
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-4 text-sm font-light text-[#A3A3A3] hover:text-[#CEB175] transition-all duration-500"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
              {[
                ...
                <a
                  key={item.label}
                  href={item.href}
                  className="group flex items-end gap-3 w-fit"
                >
                  <span className="text-3xl font-serif font-light text-[#A3A3A3] group-hover:text-white transition-all duration-500 group-hover:translate-x-2">
                    {item.label}
                  </span>
                  <span className="text-[10px] text-[#CEB175] mb-2 opacity-0 group-hover:opacity-100 transition-all duration-500">
                    {item.num}
                  </span>
                </a>
              ))}
          ...
          <Reveal className="md:col-span-3 md:col-start-10" delay={600}>
            ...
            <div className="space-y-6">
              ...
              <p className="text-xs font-light text-[#CEB175] italic opacity-80 border-l border-[#CEB175]/20 pl-4 py-1">
                Siap melayani perjalanan di seluruh wilayah Sukabumi &
                sekitarnya.
              </p>
            </div>
          </Reveal>
        ...
        {/* Inner Circle */}
        <Reveal delay={600}>
          <div className="mt-16 border-t border-[#CEB175]/8 pt-16">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
              <div className="max-w-sm">
                <p className="text-[8px] uppercase tracking-[0.6em] text-[#CEB175] mb-3 font-light">
                  — The Inner Circle —
                </p>
                <p className="font-serif italic text-[#A3A3A3] text-base leading-relaxed font-light">
                  Bisikan eksklusif tentang cerita terbaru, inspirasi estetika,
              ...
              <div className="w-full md:w-auto md:min-w-[320px]">
                {subState === "success" ? (
                  ...
                  >
                    <div className="w-6 h-px bg-[#CEB175]/40" />
                    <p className="font-serif italic text-[#CEB175]/70 text-sm">
                      Anda kini bagian dari lingkaran terpilih.
                    </p>
                  </motion.div>
                ) : (
                  <form
                    onSubmit={handleSubscribe}
                    className="flex items-stretch gap-0 border-b border-[#CEB175]/20 group focus-within:border-[#CEB175]/50 transition-colors duration-500"
                  >
                    <input
                      type="email"
                      value={email}
                      ...
                      className="flex-1 bg-transparent py-3 text-[11px] text-white/60 placeholder:text-white/15 font-light tracking-[0.1em] focus:outline-none focus:text-white/80 transition-colors duration-300 disabled:opacity-50"
                      style={{ fontFamily: "'Montserrat', sans-serif" }}
                    />
                    <button
                      type="submit"
                      disabled={subState === "loading" || !email.trim()}
                      className="group/btn flex items-center gap-2 px-4 py-3 text-[#CEB175]/50 hover:text-[#CEB175] disabled:opacity-30 transition-colors duration-300"
                      aria-label="Subscribe"
                    >
                      {subState === "loading" ? (
                        <div className="w-3 h-3 border border-[#CEB175]/50 border-t-[#CEB175] rounded-full animate-spin" />
                      ) : (
                ...
                <p className="text-[7px] uppercase tracking-[0.4em] text-white/10 mt-3 font-light">
        ...
        <Reveal delay={800}>
          <div className="mt-20 flex flex-col md:flex-row justify-between items-center gap-8 border-t border-[#CEB175]/5 pt-12">
            <p className="text-[9px] uppercase tracking-[0.5em] text-[#525252]">
              Mentari Wedding © 2026 — All Rights Reserved
            </p>
          </div>
        </Reveal>
      </div>
